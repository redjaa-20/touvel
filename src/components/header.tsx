...
export default function Header() {
  ...
  return (
    ...
    >
      <div className="w-full max-w-[1240px] mx-auto px-6 md:px-0">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center justify-end gap-10">
            ...
            <button
              className={`flex items-center justify-center gap-2.5 py-3 px-7 text-sm font-karla font-medium tracking-[0.3px] rounded-full transition-colors duration-300 ${
                isScrolled
